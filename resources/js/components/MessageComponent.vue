            ...
            >
                <div v-for="message in filteredMessage" :key="message.index">
                    ...
                    >
                        ...
                        <img
                            :src="'../storage/user_images/' + user.image"
                            alt="Picture"
                        />
                            ...
                            >
                                ...
                                <li :id="message.message_id">
                                    <img
                                        ...
                                        "
                                        class="message_image"
                                        style="border-radius:20px;width:150px;height:150px;top:30px;left:60px;"
                                    />
                                </li>
                            </ul>
                    ...
                    >
                        ...
                        <img
                            :src="'../storage/user_images/' + friend_id.image"
                            alt="Picture"
                        />
                        <div class="clearfix"></div>
                        <div class="ul_section_full">
                            ...
                            >
                                ...
                                <li :id="message.message_id">
                                    <img
                                        ...
                                        "
                                        class="message_image"
                                        style="border-radius:20px;width:150px;height:150px;top:30px;right:60px;"
                                    />
                                </li>
                            </ul>
                            <ul v-else class="ul_msg">
                ...
                >
                    <img
                        :src="'../storage/user_images/' + this.friend_id.image"
                        alt="Picture"
                    />
                    <div class="clearfix"></div>
                    <div
                        class="ul_section_full"
...
export default {
    ...
    methods: {
        ...
        deleteMessage(message) {
            if (message) {
                var result = confirm(
                    "You are sure to delete this message. '[ " +
                        message.message +
                        " ]'"
                );
                if (result) {
